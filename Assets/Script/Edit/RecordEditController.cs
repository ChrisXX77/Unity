...
namespace MyTest
{
    ...
    public class RecordEditController : MonoBehaviour
    {
        ...
        {
            if (motionData.motionFrames.Count > 0)
            {
                // Replace the last recorded frame with the current pose data
                ...
                motionData.motionFrames[motionData.motionFrames.Count - 1] = updatedValue;
                Debug.Log("Last frame replaced with the current data.");
