...
namespace MyTest
{
    public class MainController : MonoBehaviour
    {
        ...
        public string ReplaceJsonFilePath = "D://temp//test1.json";
        ...
        void OnGUI()
        {
            ...
            if (GUILayout.Button("Edit Scene", GUILayout.Width(BtnWidth), GUILayout.Height(BtnHeight)))
            {
                SaveData();
                SceneManager.LoadScene(1); // Replace with your next scene name
            }
            // Show Save and Replace buttons only when paused
